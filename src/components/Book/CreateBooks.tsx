...
const CreateBooks: React.FC<CreateBooksProps> = (props) => {
    ...
    const [author, setAuthor] = useState<null | AuthorsInDropDown>(null)
    const [validated, setValidated] = useState(false);

    const authorsOfOptionList: AuthorsInDropDown[] = props.authors.map(
        (author) => {
    ...
    const handleOnSubmit = (event: any) => {
        ...
        if (props.bookToUpdate) {
            const updatedBook: IBooks = {...props.bookToUpdate, name: name, price: price, author: author.value};
